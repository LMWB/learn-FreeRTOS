...
{
  /* USER CODE BEGIN myTask05 */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END myTask05 */
}
...
{
  /* USER CODE BEGIN myTask06 */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END myTask06 */
}
...
{
  /* USER CODE BEGIN myTask07 */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END myTask07 */
}
...
{
  /* USER CODE BEGIN myTask08 */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END myTask08 */
}
